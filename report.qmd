...
```
Figure1 plots 90 day rolling pearson correlation between daily log return of Bitcoin and Nasdaq-100 index from 2015 to present. 
Before 2017, we find that the rolling pearson correlation between daily log return of Bitcoin and Nasdaq-100 is low.
From 2017 to 2020, we find the number has a larger volatility and move upward generally speaking.
After 2020, the number increased sharply and reached all time high. And then, the number range from 0.2 to 0.5 most of the time.
This gradual increase in correlation suggests that Bitcoin has become more integrated with mainstream financial markets, which motivates our subsequent GARCH-based analysis of its volatility dynamics and spillovers.
